...
USING json
OPTIONS (path "abfss://bronze@databricksucexternalloca.dfs.core.windows.net/drivers.json");
...
USING json
OPTIONS (path "abfss://bronze@databricksucexternalloca.dfs.core.windows.net/results.json");
